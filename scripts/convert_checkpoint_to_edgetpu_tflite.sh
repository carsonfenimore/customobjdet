...
echo "GENERATING label file in ${OUTPUT_DIR}/labels.txt"
python ${scriptpathdir}/convert_pbtxt_to_labelsfile.py -l ${DATASET_DIR}/label_map.pbtxt -o ${OUTPUT_DIR}/labels.txt 

echo "EXPORTING frozen graph from checkpoint... to ${OUTPUT_DIR}"
