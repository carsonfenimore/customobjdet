...
PROJECT_NAME="tesla"
OBJ_DET_DIR="$PWD"
LEARN_DIR="${OBJ_DET_DIR}/learn_${PROJECT_NAME}"
DATASET_DIR="${LEARN_DIR}/dataset"
CKPT_DIR="${LEARN_DIR}/source_model_ckpt"
TRAIN_DIR="${LEARN_DIR}/train_output"
OUTPUT_DIR="${LEARN_DIR}/output_models"
IMAGES_SOURCE_DIR="${scriptpathdir}/images_${PROJECT_NAME}"
